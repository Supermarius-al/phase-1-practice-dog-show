...
dogForm.addEventListener('submit', (e) =>{
    e.preventDefault()
let dogName = document.querySelector("#dog-form > input[type=text]:nth-child(1)").value
let dogBreed = document.querySelector("#dog-form > input[type=text]:nth-child(2)").value
let dogSex = document.querySelector("#dog-form > input[type=text]:nth-child(3)").value
